...
const CourseDetails = () => {
  ...
  //to fetch the individual course data
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 realtive items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        <div className="absolute top-0 left-0 w-full h-section-height -z-10 bg-gradient-to-b from-cyan-100/70"></div>
        {/* left column */}
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-course-details-heading-large text-home-heading-small font-semibold text-gray-800">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <p className="text-gray-500 md:text-lg ">
                {courseData.coursePrice}% off
              </p>
            </div>

            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              <div className="flex items-center gap-1">
                <img src={assets.star} alt="star icon" className="src" />
                <p>{calculateRatings(courseData)}</p>
              </div>
              <div className="h-4 w-px bg-gray-500/40"></div>
              <div className="flex items-center gap-1">
                <img src={assets.time_clock_icon} alt="time_clock_icon" className=""/>
                <p>{calculateCourseDuration(courseData)}</p>
              </div>
              <div className="h-4 w-px bg-gray-500/40"></div>
              <div className="flex items-center gap-1">
                <img src={assets.lesson_icon} alt="lesson_icon" className="" />
